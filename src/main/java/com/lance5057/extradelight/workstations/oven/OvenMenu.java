...
//		this.inventory = tileEntity.getInventory();
		...
		this.canInteractWithCallable = tileEntity !=null ?
				ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()):ContainerLevelAccess.NULL;

		this.tileEntity = tileEntity;
		this.inventory = tileEntity !=null ? tileEntity.getInventory() : new ItemStackHandler(12);
	...
	public boolean recipeMatches(Recipe<? super RecipeWrapper> pRecipe) {
		return pRecipe.matches(new RecipeWrapper(inventory), level);
	}
