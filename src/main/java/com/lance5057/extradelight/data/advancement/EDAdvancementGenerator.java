...
public class EDAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
	...
	public static HashMap<String, RegistryObject<Item>> SNACKS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> FEASTS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> MEALS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> DESSERTS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> DRINKS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> CANDY = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> COOKIES = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> INGREDIENTS = new HashMap<String, RegistryObject<Item>>();
	public static HashMap<String, RegistryObject<Item>> BUTCHERCRAFT = new HashMap<String, RegistryObject<Item>>();

	@Override
	public void generate(Provider registries, Consumer<Advancement> consumer, ExistingFileHelper existingFileHelper) {
		Advancement start = Builder.advancement()
		...
		Advancement grater = Builder.advancement()
		...
		Advancement spoon = Builder.advancement()
		...
		Advancement mixingbowl = Builder.advancement()
		...
		Advancement burn_mint = Builder.advancement()
		...
		Advancement oven = Builder.advancement()
		...
		Advancement evaporator = Builder.advancement()
		...
		Advancement vat = Builder.advancement()
		...
		Advancement lid = Builder.advancement()
		...
		Advancement pickle = Builder.advancement()
				...
				.addCriterion("pickle",
						InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item()
								.of(ExtraDelightTags.PICKLED).withCount(MinMaxBounds.Ints.atLeast(2)).build()))
				.save(consumer, ExtraDelight.MOD_ID + ":pickle");

		Advancement trays = Builder.advancement()
		...
		Advancement mortar = Builder.advancement()
		...
		Advancement flour = Builder.advancement()
		...
		Advancement grind = Builder.advancement()
		...
		Advancement doughshaping = Builder.advancement()
		...
		Advancement hellskitchen = Builder.advancement()
		...
		Advancement noodles = Builder.advancement()
		...
		Advancement dryingrack = Builder.advancement()
		...
		Advancement yeastpot = Builder.advancement()
		...
		Advancement vinegarpot = Builder.advancement()
		...
		Advancement jelly = Builder.advancement()
		...
		Advancement jellyall = Builder.advancement()
		...
		Advancement food = Builder.advancement()
		...
		Advancement badfood = Builder.advancement()
		...
		Advancement cactus_juice = Builder.advancement()
		...
		Advancement frosting = Builder.advancement()
		...
		if (!SNACKS.isEmpty()) {
			Builder snacksBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.APPLE_CHIPS.get()))
		...
		if (!FEASTS.isEmpty()) {
			Builder feastsBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.TARTE_TATIN_IN_PAN.get()))
		...
		if (!MEALS.isEmpty()) {
			Builder mealsBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.MULLIGATAWNY_SOUP.get()))
		...
		if (!DESSERTS.isEmpty()) {
			Builder dessertBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.TARTE_TATIN_SLICE.get()))
		...
		if (!INGREDIENTS.isEmpty()) {
			Builder ingredientsBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.FROSTING_PINK.get()))
		...
		if (!DRINKS.isEmpty()) {
			Builder drinksBuilder = Builder.advancement()
...
//				.addCriterion("coffee", InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.COFFEE.get()))
		...
		if (!CANDY.isEmpty()) {
			Builder candyBuilder = Builder.advancement()
...
//								.hasItems(ExtraDelightItems.MILK_CHOCOLATE_DIPPED_BACON.get()))
		...
		if (!COOKIES.isEmpty()) {
			Builder cookiesBuilder = Builder.advancement()
...
//						InventoryChangeTrigger.TriggerInstance.hasItems(ExtraDelightItems.SUGAR_COOKIE_EMERALD.get()))
		...
		if (!BUTCHERCRAFT.isEmpty()) {
			Builder butcherBuilder = Builder.advancement()
...
//								.hasItems(ItemPredicate.Builder.item().of(ExtraDelightItems.PORK_AND_APPLES).build()))
		...
		Advancement chiller = Builder.advancement()
		...
		Advancement melting_pot = Builder.advancement()
		...
		Advancement keg = Builder.advancement()
		...
		Advancement funnel = Builder.advancement()
		...
		Advancement chocolate_bar = Builder.advancement()
		...
		Advancement fondue = Builder.advancement()
		...
		Advancement tap = Builder.advancement()
		...
		Advancement sink = Builder.advancement()
				...
				.addCriterion("sink",
						InventoryChangeTrigger.TriggerInstance
								.hasItems(ItemPredicate.Builder.item().of(AestheticBlocks.SINK_ITEMS.get(0).get()).build()))
				.save(consumer, ExtraDelight.MOD_ID + ":sink");

		Advancement counter = Builder.advancement()
