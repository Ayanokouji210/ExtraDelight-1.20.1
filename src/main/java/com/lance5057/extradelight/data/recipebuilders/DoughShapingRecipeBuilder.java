package com.lance5057.extradelight.data.recipebuilders;//package com.lance5057.extradelight.data.recipebuilders;
...
public class DoughShapingRecipeBuilder implements RecipeBuilder {
	...
	public static DoughShapingRecipeBuilder shape(Ingredient pIngredient, Item result, int count) {
		return new DoughShapingRecipeBuilder(result, pIngredient, count,
				new DoughShapingRecipe.Serializer());
	}
	...
	public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
		...
		this.advancement.parent(ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID,"recipes/root"))
		...
		pFinishedRecipeConsumer.accept(new DoughShapingRecipeBuilder.Result(saveID,
				this.group == null ? "" : this.group, this.ingredient, this.result, count, this.advancement,
						this.advancement.build(pRecipeId.withPrefix("recipes/dynamic_feast")).getId(),
				this.serializer));
	}
	...
	public static class Result implements FinishedRecipe {
		...
		public RecipeSerializer<?> getType() {
			return ExtraDelightRecipes.DOUGH_SHAPING_SERIALIZER.get();
		}
