...
//			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "chests/corn_legendary"));
	...
	public static ResourceLocation curry_powder =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/curry_powder");
	public static ResourceLocation furikake =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/furikake");
	public static ResourceLocation meals =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/meals");
	public static ResourceLocation dungeon_rot =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/dungeon_rot");

	public static ResourceLocation cactus_juice =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/cactus_juice");

	public static ResourceLocation mortar_nether =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/mortar_nether");
	public static ResourceLocation mortar_dungeon =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/mortar_dungeon");
	public static ResourceLocation pestle_nether =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/pestle_nether");
	public static ResourceLocation pestle_dungeon =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "structures/pestle_dungeon");

	public static ResourceLocation corn_common =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "chests/corn_common");
	public static ResourceLocation corn_uncommon =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "chests/corn_uncommon");
	public static ResourceLocation corn_rare =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "chests/corn_rare");
	public static ResourceLocation corn_legendary =
			ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "chests/corn_legendary");
...
//								.add(LootItem.lootTableItem(ExtraDelightItems.CANDY.get()))
						...
						.withPool(LootPool.lootPool().name("better").setRolls(UniformGenerator.between(1, 2))
								...
								.add(LootItem.lootTableItem(ExtraDelightItems.CHOCOLATE_CAKE.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.BLOOD_CHOCOLATE_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.MILK_CHOCOLATE_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.DARK_CHOCOLATE_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.WHITE_CHOCOLATE_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.BLOOD_CHOCOLATE_FILLED_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.MILK_CHOCOLATE_FILLED_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.DARK_CHOCOLATE_FILLED_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.WHITE_CHOCOLATE_FILLED_BAR.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.BLOOD_CHOCOLATE_TRUFFLE.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.MILK_CHOCOLATE_TRUFFLE.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.DARK_CHOCOLATE_TRUFFLE.get()))
								.add(LootItem.lootTableItem(ExtraDelightItems.WHITE_CHOCOLATE_TRUFFLE.get()))));
...
//								.add(LootItem.lootTableItem(ExtraDelightItems.CANDY.get()))
						...
						.withPool(LootPool.lootPool().name("better").setRolls(UniformGenerator.between(2, 4))
								...
								.add(LootItem.lootTableItem(ExtraDelightItems.EASTER_EGG.get()))));
	}
