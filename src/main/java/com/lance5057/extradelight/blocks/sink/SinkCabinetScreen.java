...
public class SinkCabinetScreen extends AbstractContainerScreen<SinkCabinetMenu> {
	...
	private static final ResourceLocation TAB_BUTTON =ResourceLocation.fromNamespaceAndPath(ExtraDelight.MOD_ID, "textures/gui/sprites/settings.png");
...
//			this.imageHeight=89;
//		}));
		this.addRenderableWidget(new ImageButton(this.leftPos - 24, this.topPos, 24, 24,0,0,-1, TAB_BUTTON, 24,24,(button) -> {
			this.switchTabs();
			this.imageWidth = 175;
			this.imageHeight=89;
		}));
